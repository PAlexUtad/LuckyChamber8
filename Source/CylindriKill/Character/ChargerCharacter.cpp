...
void AChargerCharacter::UpdateMovement(float DeltaTime)
{
	...
	if (bIsCharging)
	{
		...
		if (Distance <= FireRange)
		{
			...
			GetWorldTimerManager().SetTimer(FireTimerHandle, this, &AChargerCharacter::FireAtPlayer, CloseRangeShootInterval, true, 0.f);		}
		return;
	}
